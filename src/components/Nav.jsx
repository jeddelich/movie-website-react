...
function handleContactModal() {
  ...
  return (
    ...
    aboutModal && <Modal modalTitle="Your Next Movie Is Our Mission" modalPara="Whether it's for your next family movie night, a romantic date, or to discover your next binge-worthy TV series, Cinemations is here to help! With our vast database of
            movies and TV shows, we guarantee you'll find all the info you need to pick your next hit movie!" modalClose={handleAboutModal} contactModal={contactModal} aboutModal={aboutModal}/>
    }
    { 
    contactModal && <Modal modalTitle="Can't Find Your Movie Anywhere?" modalPara="We do our best to keep our library updated, but we need your help! Please contact us and let us know what we're missing!" modalClose={handleContactModal} contactModal={contactModal} aboutModal={aboutModal}/>
    }
    <nav>
